	...
	$(document).ready(function() {
	    ...
	    $('.req-save-update-btn').click(function() {
			...
			if ($('#id').val().trim().length > 0) {
				...
				w2alert("Please Select a Team Leader.");
				return flag;
			}
...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #5BBC2E;">Team Wise Report Form</h2>		
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form id="departmentForm" cssClass="form-horizontal" method="GET" modelAttribute="command"
								action="${pageContext.request.contextPath}/downLoadTeamWise" target="_blank"
								class="form-horizontal" role="form">
								
								
								
								<div class="form-group">
									<label class="col-lg-2 control-label">TeamLeader Name: </label>
									<div class="col-lg-5">
