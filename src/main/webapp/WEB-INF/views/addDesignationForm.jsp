...
<c:url var="findURL" value="/checkDesignation" />
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form:form id="designationForm" cssClass="form-horizontal" method="POST" modelAttribute="designationForm"
								action="${pageContext.request.contextPath}/saveDesignation"
								...
								<div class="form-group">
									<label class="col-lg-2 control-label">Designation <span class="red">*</span>:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
										<form:input id="remarks" path="remarks" value="${designation.remarks}"
											class="form-control"/>
									</div>
								</div>
										...
										<c:when test="${edit}">
											...
											<div class="col-lg-1 col-xs-4">
												<a class="btn btn-sm btn-danger"
													href="${pageContext.request.contextPath}/addDesignationForm">Cancel</a>
											</div>
										</c:when>
										<c:otherwise>
											<div class="col-lg-offset-2 col-lg-1 col-xs-4" id="">
											...
											<tbody>
												<c:forEach items="${designationList}" var="desig" varStatus="slNo">
													<tr>
														...
														<td class="text-center"><c:out value="${desig.remarks}" /></td>
														<td class="text-center">
															<a class="btn btn-primary custom" href="editDesignation?id=${desig.id}">Edit</a> 
														</td>
													</tr>
												</c:forEach>
