...
<body>
	...
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">${status} Employee List</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div>
								...
								<label><input type="checkbox" class="toggle-vis" data-column="3" checked="checked"> Department</label>
								<label><input type="checkbox" class="toggle-vis" data-column="4" checked="checked"> Sub Department</label>
								<label><input type="checkbox" class="toggle-vis" data-column="5" checked="checked"> Designation</label>
								
								<label><input type="checkbox" class="toggle-vis" data-column="6" checked="checked"> Supervisor</label>
								<label><input type="checkbox" class="toggle-vis" data-column="7" checked="checked"> Point</label>
								<label><input type="checkbox" class="toggle-vis" data-column="8" checked="checked"> Status</label>
								<label><input type="checkbox" class="toggle-vis" data-column="9" checked="checked"> Sort Order</label>
											...
											<tbody>
												<c:forEach items="${employeeList}" var="employee"
													...
													<tr>
														...
														<td class="text-center">${employee.subDepartment.name}</td>
														<td class="text-center">${employee.designation.name}</td>
														
														<td class="text-center">
														<c:if test="${!empty employee.manager}">
														${employee.manager.name}-(${employee.manager.empId}) </c:if></td>
														<td class="text-center">${employee.point.name}</td>
														<td class="text-center">${employee.status} </td>
														<td class="text-center">${employee.sortOrder}</td>
